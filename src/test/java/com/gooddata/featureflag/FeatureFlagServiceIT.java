...
public class FeatureFlagServiceIT extends AbstractGoodDataIT {
    ...
    @Test
    public void getFeatureFlagsShouldReturnAggregatedFlagsForProject() throws Exception {
        onRequest()
        ...
        final FeatureFlags flags = service.getFeatureFlags(project);
    ...
    @Test
    public void getProjectFeatureFlagsShouldReturnProjectFeatureFlags() throws Exception {
        onRequest()
                .havingMethodEqualTo("GET")
        ...
        final ProjectFeatureFlags flags = service.getProjectFeatureFlags(project);
    ...
    public void createProjectFeatureFlagShouldCreateAndReturnNewProjectFeatureFlag() {
        ...
        assertThat(featureFlag.getEnabled(), is(true));
    }
