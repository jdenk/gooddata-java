...
public class FeatureFlagService extends AbstractService {
     ...
     */
    public FeatureFlags getFeatureFlags(final Project project) {
    ...
    /**
     * Returns project feature flags (only project scoped flags, use {@link #getFeatureFlags(Project)} for aggregated
     ...
     */
    public ProjectFeatureFlags getProjectFeatureFlags(final Project project) {
        notNull(project, "project");
        try {
     ...
     */
    public ProjectFeatureFlag createProjectFeatureFlag(final Project project, final ProjectFeatureFlag featureFlag) {
        notNull(project, "project");
        ...
        try {
            ...
            if (featureFlagUri == null) {
                throw new RuntimeException("URI of new featureFlag can't be null");
            }
    ...
    private ProjectFeatureFlag getProjectFeatureFlag(final String featureFlagUri) {
